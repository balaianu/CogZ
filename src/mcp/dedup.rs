//! Basic dedup — title match and embedding similarity.
//!
//! This is the Phase 7 lightweight dedup. Full consolidation
//! (contradiction detection, promotion, merge) is Phase 9.
//!
...
pub struct DedupResult {
    ...
    /// True if an NLI contradiction was detected (always false in
    /// Phase 7 — NLI is Phase 9).
